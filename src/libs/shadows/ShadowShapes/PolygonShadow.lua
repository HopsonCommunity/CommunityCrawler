module("libs.shadows.ShadowShapes.PolygonShadow", package.seeall)

Shadows = require("libs.shadows")
Transform = require("libs.shadows.Transform")
OutputShadow = require("libs.shadows.OutputShadow")

Shadow = require("libs.shadows.ShadowShapes.Shadow")
