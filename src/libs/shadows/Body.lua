module("libs.shadows.Body", package.seeall)

Object = require("libs.shadows.Object")

PriorityQueue		=	require("libs.shadows.PriorityQueue")
Shadows			=	require("libs.shadows")
Transform		=	require("libs.shadows.Transform")

CircleShadow		=	require("libs.shadows.ShadowShapes.CircleShadow")
